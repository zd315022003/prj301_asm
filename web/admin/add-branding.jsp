    ...
    <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mx-auto">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                ...
                <form action="add-branding" method="post" class="tm-edit-product-form">
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary btn-block text-uppercase">Add Branding Now</button>
                    </div>
                </form>
                <!-- </div> -->
            </div>
