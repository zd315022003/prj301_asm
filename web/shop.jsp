<%-- 
    Document   : shop
    Created on : Jun 26, 2023, 11:00:14 AM
    Author     : Admin
--%>
                                                            ...
                                                            <c:forEach items="${categories}" var="category">
                                                                <li>
                                                                    <input type="checkbox" 
                                                                           ...
                                                                           />
                                                                    <label for="category-${category.id}">${category.name} (${category.count})</label>
                                                                </li>
                                                            </c:forEach>
                                                        </ul>
                                                    </div>
                            ...
                            <c:forEach items="${products}" var="product">
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="img/product/${product.thumbnail}.jpg">
                                        ...
                                        <div class="product__item__text">
                                            <h6>${product.title}</h6>
                                            <!-- TODO: change this to action add to cart -->
                                            <a href="./shop-details.jsp?id=${product.id}" class="add-cart">+ Add To Cart</a>
                                            <h5 style="color: gray"><del>$${product.price}</del></h5>
                                            <h5>$${product.sale}</h5>
                                            <!-- TODO: determine should this be here? -->
